                ...
                <view class="board-container">
                    ...
                    <view class="board-wrapper">
                        <view class="board">
                            ...
                            <view v-if="animatingPiece" class="animating-piece" :style="animatingPieceStyle">
                ...
                <view class="player-info right-player"
                    ...
                    <view class="player-name-container">
                        <input v-if="players[1]?.id === playerId && editingName" class="player-name-input"
                            v-model="tempName" @blur="saveName" @confirm="saveName" focus />
                        <view v-else class="player-name" @click="startEditName(1)">{{ players[1]?.name || '等待玩家' }}</view>
    ...
    export default {
        ...
        methods: {
            ...
            shareGame() {
                ...
                const shareUrl = `https://localhost:8000/?room=${this.roomId}`
                // 或者使用房间号直接加入的方式
